...
<section class="section">
    ...
    <div class="tab-content events panel">
        <?php foreach ($evenements as $event) { ?>
            <form method="post" action="<?php echo e(urlSite('/event/delete.php')); ?>" class="row confirm-form">
                <input type="hidden" name="csrf_token" value="<?php echo e(jetonCSRF()); ?>">
                ...
                <button class="btn ghost" name="publier_evenement" formaction="<?php echo e(urlSite('/dashboard/admin.php')); ?>" type="submit">Publier</button>
                <button class="btn ghost" name="annuler_evenement" formaction="<?php echo e(urlSite('/dashboard/admin.php')); ?>" type="submit">Annuler</button>
