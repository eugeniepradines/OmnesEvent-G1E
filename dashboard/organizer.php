...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['presence_id'])) {
    ...
    rediriger('/dashboard/organizer.php?event=' . (int)$_POST['event_id']);
}
...
<section class="section">
    <div class="section-title">
        ...
        <a class="btn" href="<?php echo e(urlSite('/event/create.php')); ?>">Creer un evenement</a>
    </div>
    <div class="dashboard-grid">
        ...
        ?>
            <article class="panel">
                ...
                <div class="actions">
                    <a class="btn ghost" href="<?php echo e(urlSite('/dashboard/organizer.php?event=' . (int)$event['id'])); ?>">Inscrits</a>
                    <a class="btn ghost" href="<?php echo e(urlSite('/event/edit.php?id=' . (int)$event['id'])); ?>">Modifier</a>
                    <form method="post" action="<?php echo e(urlSite('/event/delete.php')); ?>" class="inline-form confirm-form">
