...
('Soiree Neon Campus', 'Une soiree etudiante lumineuse avec DJ set et animations.', 'Soirée', '2026-06-12 20:30:00', 'Atrium Omnes', '10 rue Sextius Michel, Paris', 48.8466367, 2.2860259, '/assets/img/default-event.svg', 120, 0.00, 2, 'publie', NOW()),
('Tournoi Futsal Interpromo', 'Equipes mixtes, phase de poules puis finale.', 'Sport', '2026-06-18 18:00:00', 'Gymnase Omnes', 'Campus Lyon', 45.7640430, 4.8356590, '/assets/img/default-event.svg', 60, 5.00, 3, 'publie', NOW()),
('Expo Photo Campus', 'Exposition des meilleurs cliches realises par les etudiants.', 'Culture', '2026-06-22 12:00:00', 'Hall principal', 'Campus Paris', 48.8566140, 2.3522219, '/assets/img/default-event.svg', 80, 0.00, 2, 'publie', NOW()),
('Conference IA & Ethique', 'Rencontre autour des usages responsables de l intelligence artificielle.', 'Conférence', '2026-07-02 17:30:00', 'Amphi A', 'Campus Paris', 48.8566140, 2.3522219, '/assets/img/default-event.svg', 100, 8.00, 2, 'publie', NOW()),
('Afterwork Alumni', 'Temps reseau entre etudiants et anciens diplomes.', 'Autre', '2026-07-09 19:00:00', 'Rooftop Omnes', 'Campus Lyon', 45.7640430, 4.8356590, '/assets/img/default-event.svg', 90, 0.00, 2, 'publie', NOW()),
('Run Solidaire', 'Course de 5 km au profit d une association partenaire.', 'Sport', '2026-07-16 09:30:00', 'Parc Blandan', 'Lyon', 45.7458768, 4.8511955, '/assets/img/default-event.svg', 150, 3.00, 3, 'publie', NOW());
